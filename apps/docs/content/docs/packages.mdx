...
| Native Node.js | `npm install @betteroffice/docx-node` | [JavaScript](./javascript#run-natively-in-nodejs) |
...
| --- | --- | --- | --- |
| DOCX | `@betteroffice/docx`, `@betteroffice/docx-react`, `@betteroffice/docx-node` | `betteroffice-docx` | `betteroffice-docx` |
| XLSX | `@betteroffice/xlsx`, `@betteroffice/xlsx-react`, `@betteroffice/xlsx-node` | `betteroffice-xlsx` | `betteroffice-xlsx` |
| PPTX | `@betteroffice/pptx`, `@betteroffice/pptx-react`, `@betteroffice/pptx-node` | `betteroffice-pptx` | `betteroffice-pptx` |
...
- **A server, CLI, or Electron app in Node.js** — the `-node` packages. They
