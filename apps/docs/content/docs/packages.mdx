...
| Native Node.js | `npm install @betteroffice/docx-native` | [JavaScript](./javascript#run-natively-in-nodejs) |
...
- **A server, CLI, or Electron app in Node.js** — the `-native` packages. They
