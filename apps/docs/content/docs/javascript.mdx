...
The packages run under Node.js 18+ and Bun.
...
the same Rust facades as prebuilt native binaries instead. Headless parsing
...
| `@betteroffice/docx-native` | Native Node.js binding for DOCX inspection, editing, layout, PNG rendering, and saving. |
...
| `@betteroffice/xlsx-native` | Native Node.js binding for XLSX calculation, editing, collaboration, proposals, PNG rendering, and saving. |
...
| `@betteroffice/pptx-native` | Native Node.js binding for PPTX inspection, editing, collaboration, proposals, PNG rendering, and saving. |
